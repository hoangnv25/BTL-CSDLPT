...
import ProductDetailModal from '../Product/ProductDetailModal'; // Reuse existing product detail modal since it's already read-only!
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.header}>
        <h1 className={styles.title}>Xem Sản Phẩm</h1>
      </div>
          ...
          <table className={styles.table}>
            <thead>
              <tr>
                ...
                <th className={styles.th} style={{ width: '45%' }}>Tên Sản Phẩm</th>
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan="5" className={styles.emptyState}>Không tìm thấy sản phẩm nào phù hợp.</td>
                </tr>
              ) : (
